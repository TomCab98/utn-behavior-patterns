...
@Getter
public class AlumnoMediator extends UsuarioMediator {
  private final Logger logger = Logger.getInstance();

  public AlumnoMediator(Alumno alumno, ChatMediator mediator) {
    super(alumno, mediator);
  }

  @Override
  public void enviar(String mensaje) {
    logger.info("\n[" + obtenerTimestamp() + "] " + usuario.getNombre() + " (Alumno): " + LogColor.WHITE_CURSIVE.getColor() + mensaje + LogColor.RESET.getColor());
    mediator.enviarMensaje(mensaje, this);
  }

  @Override
  public void enviarPrivado(String mensaje, UsuarioMediator receptor) {
    logger.info("\n[" + obtenerTimestamp() + "] " + usuario.getNombre() + " (Alumno) envia mensaje privado a " + receptor.getUsuario().getNombre());
  ...
  public void recibir(String mensaje, UsuarioMediator emisor) {
    ...
    logger.log(usuario.getNombre() + " recibio el mensaje", LogColor.SKY);
  }
}
